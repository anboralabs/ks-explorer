...
public class UnlockPanel {
  ...
  public JComponent getComponent() { return unlockPanel; }
  ...
  public void addKeyListener(KeyListener l) { passwordField.addKeyListener(l); }

  public void setVisible(boolean visible) { unlockPanel.setVisible(visible); }
}
