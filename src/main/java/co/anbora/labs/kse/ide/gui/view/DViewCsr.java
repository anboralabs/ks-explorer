...
public class DViewCsr extends CertEditor {
     ...
     */
    public DViewCsr(Project project, VirtualFile file, PKCS10CertificationRequest pkcs10Csr) throws CryptoException {
        super(project, file);
     ...
     * @throws CryptoException A crypto problem was encountered constructing the dialog
     */
    public DViewCsr(Project project, VirtualFile file, Spkac spkacCsr) throws CryptoException {
        super(project, file);
