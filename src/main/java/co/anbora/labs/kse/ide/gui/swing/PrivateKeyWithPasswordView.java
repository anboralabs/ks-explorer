...
public class PrivateKeyWithPasswordView
    extends CertEditor implements StatusBar, AddPrivateKey {

  private final UnlockPanel customUnlockPanel =
      new UnlockPanel("Unlock Private key");
  ...
  public PrivateKeyWithPasswordView(@NotNull Project projectArg,
  ...
  private void initUnlockPanel(@NotNull Project projectArg) {
    ActionBehavior actionBehavior = new OpenPrivateKeyImpl(
        this, this, customUnlockPanel.getPasswordField());
    ...
    customUnlockPanel.addKeyListener(
        new PressEnterAction(projectArg, this, actionBehavior));
  }
  ...
  @Override
  public void addPrivateKey(@Nullable PrivateKey privateKey)
