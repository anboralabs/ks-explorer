...
public enum OpenSslPbeType implements PbeType {
   ...
   * DES CBC
   */
  DES_CBC("DES-CBC", "DES/CBC/PKCS5Padding", 64, 64,
          "OpenSslPbeType.PbeWithDesCbc"),

  /**
   * Triple DES CBC
   */
  DESEDE_CBC("DES-EDE3-CBC", "DESede/CBC/PKCS5Padding", 192, 64,
             "OpenSslPbeType.PbeWithDesedeCbc"),

  /**
   * 128 bit AES CBC
   */
  AES_128BIT_CBC("AES-128-CBC", "AES/CBC/PKCS5Padding", 128, 128,
                 "OpenSslPbeType.PbeWith128BitAesCbc"),

  /**
   * 192 bit AES CBC
   */
  AES_192BIT_CBC("AES-192-CBC", "AES/CBC/PKCS5Padding", 192, 128,
                 "OpenSslPbeType.PbeWith192BitAesCbc"),

  /**
   * 256 bit AES CBC
   */
  AES_256BIT_CBC("AES-256-CBC", "AES/CBC/PKCS5Padding", 256, 128,
                 "OpenSslPbeType.PbeWith1256itAesCbc");
  ...
  OpenSslPbeType(String dekInfo, String jceCipher, int keySize, int saltSize,
                 String friendlyKey) {
   ...
   */
  public String dekInfo() { return dekInfo; }
   ...
   */
  public String jceCipher() { return jceCipher; }
   ...
   * @return Salt size
   */
  public int saltSize() { return saltSize; }
