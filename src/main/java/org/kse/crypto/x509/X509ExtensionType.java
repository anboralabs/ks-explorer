...
public enum X509ExtensionType {
  ...
  ENTRUST_VERSION_INFORMATION("1.2.840.113533.7.65.0",
                              "EntrustVersionInformationCertExt"),

  /** Authority Information Access */
  AUTHORITY_INFORMATION_ACCESS("1.3.6.1.5.5.7.1.1",
                               "AuthorityInformationAccessCertExt"),

  /** Authority Information Access */
  SUBJECT_INFORMATION_ACCESS("1.3.6.1.5.5.7.1.11",
                             "SubjectInformationAccessCertExt"),
  ...
  NETSCAPE_CERTIFICATE_TYPE("2.16.840.1.113730.1.1",
                            "NetscapeCertificateTypeCertExt"),
  ...
  NETSCAPE_REVOCATION_URL("2.16.840.1.113730.1.3",
                          "NetscapeRevocationUrlCertExt"),

  /** Netscape CA Revocation URL */
  NETSCAPE_CA_REVOCATION_URL("2.16.840.1.113730.1.4",
                             "NetscapeCaRevocationUrlCertExt"),

  /** Netscape Certificate Renewal URL */
  NETSCAPE_CERTIFICATE_RENEWAL_URL("2.16.840.1.113730.1.7",
                                   "NetscapeCertificateRenewalUrlCertExt"),
  ...
  AUTHORITY_ATTRIBUTE_IDENTIFIER("2.5.29.38",
                                 "AuthorityAttributeIdentifierCertExt"),

  /** Role Spec Cert Identifier */
  ROLE_SPECIFICATION_CERTIFICATE_IDENTIFIER(
      "2.5.29.39", "RoleSpecificationCertificateIdentifierCertExt"),
  ...
  ACCEPTABLE_CERTIFICATE_POLICIES("2.5.29.52",
                                  "AcceptableCertificatePoliciesCertExt"),
  ...
  ACCEPTABLE_PRIVILEGE_POLICIES("2.5.29.57",
                                "AcceptablePrivilegePoliciesCertExt"),
  ...
  PRIMARY_KEY_USAGE_RESTRICTION_OBS("2.5.29.4",
                                    "PrimaryKeyUsageRestrictionObsCertExt"),
  ...
  ISSUING_DISTRIBUTION_POINT_OBS("2.5.29.26",
                                 "IssuingDistributionPointObsCertExt"),
  ...
  /**
   * Indicates that the certificate is a Qualified Certificate in accordance
  ...
  /**
     A CA specifies by including this extension in the certificate of an OCSP
     responder that the requester can trust the certificate and need not obtain
  ...
  MS_ENROLL_CERT_TYPE_EXTENSION("1.3.6.1.4.1.311.20.2",
  ...
  VS_SERIAL_NUMBER_ROLLOVER("2.16.840.1.113733.1.6.7",
                            "VeriSignSerialNumberRollover"),
  VS_TOKEN_TYPE("2.16.840.1.113733.1.6.8", "VeriSignTokenType"),
  VS_IN_BOX_V2("2.16.840.1.113733.1.6.10", " VeriSignNetscapeInBoxV2"),
  VS_ON_SITE_JURISDICTION_HASH("2.16.840.1.113733.1.6.11",
  ...
  // ////////////////////////////////
  // Apple, see CPS:
  // http://images.apple.com/certificateauthority/pdf/Apple_Developer_ID_CPS_v3.2.pdf
  // ////////////////////////////////

  APPLE_CODE_SIGNING("1.2.840.113635.100.6.1.13",
                     "AppleApplicationCodeSigning"),
  APPLE_INSTALLER_SIGNING("1.2.840.113635.100.6.1.14",
                          "AppleInstallerPackageSigning"),
