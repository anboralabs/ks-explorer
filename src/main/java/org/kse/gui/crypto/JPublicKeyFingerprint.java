...
public class JPublicKeyFingerprint extends JPanel {
   ...
   */
  public JPublicKeyFingerprint(Project project, int columns) {
  ...
  private void initComponents(int columns) {
    ...
    jcbFingerprintAlg.setToolTipText(
        res.getString("JPublicKeyFingerprint.jcbFingerprintAlg.tooltip"));
    ...
    jbViewPublicKeyFingerprint.setToolTipText(res.getString(
        "JPublicKeyFingerprint.jbViewPublicKeyFingerprint.tooltip"));
  ...
  private void populateFingerprintAlgs() {
    PublicKeyFingerprintAlgorithm[] fingerprintAlgorithms =
        PublicKeyFingerprintAlgorithm.values();

    for (PublicKeyFingerprintAlgorithm fingerprintAlgorithm :
  ...
  private void populateFingerprint() {
    if (publicKey != null) {
      ...
      try {
        byte[] fingerprint = PublicKeyFingerprintUtil.calculateFingerprint(
            publicKey, fingerprintAlg);
  ...
  private void displayFingerprint() {
    ...
    if (container instanceof JDialog) {
        DViewPublicKeyFingerprint dViewPublicKeyFingerprint = new
    DViewPublicKeyFingerprint( (JDialog) container, publicKey, fingerprintAlg);
        dViewPublicKeyFingerprint.setLocationRelativeTo(container);
        dViewPublicKeyFingerprint.setVisible(true);
    } else if (container instanceof JFrame) {
        DViewPublicKeyFingerprint dViewPublicKeyFingerprint = new
    DViewPublicKeyFingerprint( (JFrame) container, publicKey, fingerprintAlg);
        dViewPublicKeyFingerprint.setLocationRelativeTo(container);
        dViewPublicKeyFingerprint.setVisible(true);
    }*/
  }
