...
public class DViewPem extends JEscDialog {
     ...
     *                         encoding
     */
    public DViewPem(Project project, String title, X509Certificate cert) throws CryptoException {
     ...
     */
    public DViewPem(Project project, String title, PKCS10CertificationRequest pkcs10Csr) throws CryptoException {
        super(project, DialogWrapper.IdeModalityType.PROJECT);
        setTitle(title);
     ...
     */
    public DViewPem(Project project, String title, PrivateKey privateKey) throws CryptoException {
        super(project, DialogWrapper.IdeModalityType.PROJECT);
        setTitle(title);
     ...
     * @throws CryptoException
     */
    public DViewPem(Project project, String title, PublicKey publicKey) throws CryptoException {
        super(project, DialogWrapper.IdeModalityType.PROJECT);
        setTitle(title);
