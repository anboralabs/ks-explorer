...
public class Version implements Comparable<Object>, Serializable {
  ...
  private static transient ResourceBundle res =
      ResourceBundle.getBundle("org/kse/version/resources");
   ...
   */
  public Version(String version) throws VersionException { this(version, "."); }
  ...
  public Version(String version, String delimiters) {
    ...
    while (strTok.hasMoreTokens()) {
      try {
        ...
        if (i < 0) {
          throw new VersionException(MessageFormat.format(
              res.getString("NoParseVersion.exception.message"), version,
              delimiters));
        }
  ...
  private List<Integer> getSections() { return new ArrayList<>(iSections); }
  ...
  /**
   * Gets major version (first part of a version string, e.g. for version
   * "1.2.3" it returns "1")
   *
   * @return Major version
   */
  public int getMajor() { return iSections.get(0); }

  /**
   * Gets minor version (second part of a version string, e.g. for version
   * "1.2.3" it returns "2")
   *
  ...
  /**
   * Gets bug fix version (third part of a version string, e.g. for version
   * "1.2.3" it returns "3")
   *
