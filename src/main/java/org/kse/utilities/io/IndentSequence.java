...
public class IndentSequence {
  public static final IndentSequence FOUR_SPACES =
      new IndentSequence(IndentChar.SPACE, 4);
  public static final IndentSequence SINGLE_TAB =
      new IndentSequence(IndentChar.TAB, 1);
   ...
   * @return
   */
  public IndentChar getIndentChar() { return indentChar; }
}
