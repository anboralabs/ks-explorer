...
public class ManualProxySelector extends ProxySelector {
   ...
   */
  public ManualProxySelector(ProxyAddress httpProxyAddress,
  ...
  public List<Proxy> select(URI uri) {
    ...
    if ((uri.getScheme().equals("http")) && (httpProxy != null)) {
      ...
      proxies.add(ftpProxy);
               ...
               null) // Use SOCKS if available and no proxy yet identified
    {
  ...
  private void createProxies() {
    ...
    if ((httpProxy == null) && (httpsProxy == null) && (ftpProxy == null) &&
        (socksProxy == null)) {
      // Note: Proxy.Type.HTTP is used by Proxy to represent al of http,  https
      // and ftp
      if (httpProxyAddress != null) {
        httpProxy =
            new Proxy(Proxy.Type.HTTP, httpProxyAddress.getInetSocketAddress());
      }

      if (httpsProxyAddress != null) {
        httpsProxy = new Proxy(Proxy.Type.HTTP,
                               httpsProxyAddress.getInetSocketAddress());
      }

      if (ftpProxyAddress != null) {
        ftpProxy =
            new Proxy(Proxy.Type.HTTP, ftpProxyAddress.getInetSocketAddress());
      }

      if (socksProxyAddress != null) {
        socksProxy = new Proxy(Proxy.Type.SOCKS,
                               socksProxyAddress.getInetSocketAddress());
      }
    }
  }
   ...
   */
  public ProxyAddress getHttpProxyAddress() { return httpProxyAddress; }
   ...
   */
  public ProxyAddress getHttpsProxyAddress() { return httpsProxyAddress; }
   ...
   */
  public ProxyAddress getFtpProxyAddress() { return ftpProxyAddress; }
   ...
   */
  public ProxyAddress getSocksProxyAddress() { return socksProxyAddress; }
  ...
  public boolean equals(Object object) {
    ...
    ProxyAddress cmpHttpProxyAddress =
        cmpManualProxySelector.getHttpProxyAddress();
    ...
    ProxyAddress cmpHttpsProxyAddress =
        cmpManualProxySelector.getHttpsProxyAddress();

    boolean httpsEquals =
        (proxyHttpsAddress == null
    ...
    ProxyAddress cmpFtpProxyAddress =
        cmpManualProxySelector.getFtpProxyAddress();

    boolean ftpEquals =
        (proxyFtpAddress == null ? cmpFtpProxyAddress == null
    ...
    ProxyAddress cmpSocksProxyAddress =
        cmpManualProxySelector.getSocksProxyAddress();
