...
import co.anbora.labs.kse.ide.gui.KeyStorePasswordDialog
...
class KSEditorProvider: AsyncFileEditorProvider, DumbAware {
    ...
    override fun createEditorAsync(project: Project, file: VirtualFile): AsyncFileEditorProvider.Builder {
        val passwordDialog = KeyStorePasswordDialog()
        if (passwordDialog.showAndGet()) {
            ksPassword = passwordDialog.getPassword()
        }
