...
public class DialogHelper {
  ...
  /**
   * Populate a JComboBox with signature algorithms depending on the key pair
   * type.
   *
   * @param keyPairType
   * @param privateKey
   ...
   */
  public static void
  populateSigAlgs(KeyPairType keyPairType, PrivateKey privateKey,
   ...
   */
  public static void populatePkcs10Challenge(Attribute[] attributes,
                                             JTextField textField) {

    ASN1ObjectIdentifier pkcs9AtChallengepassword =
   ...
   */
  public static void populatePkcs10UnstructuredName(Attribute[] attributes,
                                                    JTextField textField) {

    ASN1ObjectIdentifier pkcs9UnstructureName =
        PKCSObjectIdentifiers.pkcs_9_at_unstructuredName;
    populateTextField(attributes, textField, pkcs9UnstructureName);
  }

  private static void populateTextField(Attribute[] attrs, JTextField textField,
                                        ASN1ObjectIdentifier pkcs9Attr) {
    if (attrs != null) {
