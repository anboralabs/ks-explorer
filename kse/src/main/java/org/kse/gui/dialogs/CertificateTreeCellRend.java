...
public class CertificateTreeCellRend extends DefaultTreeCellRenderer {
  ...
  @Override
  public Component
  getTreeCellRendererComponent(JTree jtrHierarchy, Object value,
                               boolean isSelected, boolean isExpanded,
                               boolean leaf, int row, boolean hasFocus) {
    JLabel cell = (JLabel)super.getTreeCellRendererComponent(
        jtrHierarchy, value, isSelected, isExpanded, leaf, row, hasFocus);
    ...
    if (userObject instanceof X509Certificate) {
      ...
      ImageIcon icon =
          new ImageIcon(getClass().getResource("images/certificate_node.png"));
      cell.setIcon(icon);
