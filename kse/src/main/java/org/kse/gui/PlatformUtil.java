...
public class PlatformUtil {
  ...
  public static JPanel createDialogButtonPanel(JButton jbPositive) {
    return createDialogButtonPanel(
        (jbPositive == null ? null : new JButton[] {jbPositive}));
  }
  ...
  public static JPanel createDialogButtonPanel(JButton jbPositive,
                                               JButton jbNegative) {
    return createDialogButtonPanel(
        (jbPositive == null ? null : new JButton[] {jbPositive}), jbNegative);
  }
  ...
  public static JPanel createDialogButtonPanel(JButton jbPositive,
                                               ...
                                               JButton jbOther) {
    return createDialogButtonPanel(
        jbPositive, jbNegative,
        (jbOther == null ? null : new JButton[] {jbOther}));
  }
  ...
  public static JPanel createDialogButtonPanel(JButton[] jbPositives,
    ...
    JPanel panel =
        new JPanel(new MigLayout(insets + "nogrid, fillx, aligny 100%"));
   ...
   * @return Scroll pane
   */
  public static JScrollPane createScrollPane(Component view, int vsbPolicy,
                                             int hsbPolicy) {
    // If Mac l&f convert supplied "scroll bars as needed" to "scroll bars
    // always"
