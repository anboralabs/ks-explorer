...
public class X509Ext {
  ...
  public static final IndentSequence INDENT =
      new IndentSequence(IndentChar.SPACE, 4);
   ...
   */
  public boolean isCriticalExtension() { return critical; }
  ...
  public String getStringValue() throws IOException {
    ...
    default:
      // X509Extension not recognized or means to output it not defined - just
   ...
   */
  public static byte[] wrapInOctetString(byte[] extensionValue)
      throws IOException {
  ...
  private static String getEntrustVersionInformationStringValue(byte[] value)
      throws IOException {
    // @formatter:off
    ...
    ASN1Sequence entrustVersInfo =
        (ASN1Sequence)ASN1Primitive.fromByteArray(value);

    DERGeneralString entrustVers =
        (DERGeneralString)entrustVersInfo.getObjectAt(0);
    DERBitString entrustInfoFlags =
        (DERBitString)entrustVersInfo.getObjectAt(1);

    sb.append(MessageFormat.format(res.getString("EntrustVersion"),
                                   entrustVers.getString()));
    sb.append(NEWLINE);
    sb.append(MessageFormat.format(res.getString("EntrustInformationFlags"),
                                   entrustInfoFlags.getString()));
    sb.append(NEWLINE);

    return sb.toString();
  }

  private static String getAuthorityInformationAccessStringValue(byte[] value)
      throws IOException {
    // @formatter:off
    ...
    AuthorityInformationAccess authorityInfoAccess =
        AuthorityInformationAccess.getInstance(value);

    int accessDesc = 0;

    for (AccessDescription accessDescription :
         authorityInfoAccess.getAccessDescriptions()) {
      accessDesc++;
      ...
      AccessMethodType accessMethodType =
          AccessMethodType.resolveOid(accessMethod.getId());
      ...
      sb.append(MessageFormat.format(
          res.getString("AuthorityInformationAccess"), accessDesc));
      sb.append(NEWLINE);
      sb.append(INDENT);
      sb.append(
          MessageFormat.format(res.getString("AccessMethod"), accessMethodStr));
      sb.append(NEWLINE);
      sb.append(INDENT);
  ...
  private static String getSubjectInformationAccessStringValue(byte[] value)
      throws IOException {
    // @formatter:off
    ...
    for (AccessDescription accessDescription :
         subjectInfoAccess.getAccessDescriptionList()) {
      accessDesc++;
      ...
      sb.append(MessageFormat.format(res.getString("SubjectInformationAccess"),
                                     accessDesc));
      sb.append(NEWLINE);
      sb.append(INDENT);
      sb.append(
  ...
  private static String getSubjectDirectoryAttributesStringValue(byte[] value)
      throws IOException {
    // @formatter:off
     ...
     * }
     *
     * RFC 3739: "Compliant implementations SHALL be able to interpret the
     * following attributes:" DateOfBirth (1.3.6.1.5.5.7.9.1) ::=
     * GeneralizedTime PlaceOfBirth (1.3.6.1.5.5.7.9.2) ::= DirectoryString
     *    Gender (1.3.6.1.5.5.7.9.3) ::= PrintableString (SIZE(1)) -- "M", "F",
     * "m" or "f" CountryOfCitizenship (1.3.6.1.5.5.7.9.4) ::= PrintableString
     * (SIZE (2)) -- ISO 3166 Country Code CountryOfResidence
     * (1.3.6.1.5.5.7.9.5) ::= PrintableString (SIZE (2)) -- ISO 3166 Country
     * Code
     */
    ...
    SubjectDirectoryAttributes subjectDirectoryAttributes =
        SubjectDirectoryAttributes.getInstance(value);
    ...
    for (Object attribute : subjectDirectoryAttributes.getAttributes()) {
      ...
      AttributeTypeType att =
          AttributeTypeType.resolveOid(attributeType.getId());
      String attributeTypeStr = (att == AttributeTypeType.UNKNOWN)
                                    ? attributeType.getId()
                                    : att.friendly();

      ASN1Encodable[] attributeValues =
          ((Attribute)attribute).getAttributeValues();

      for (ASN1Encodable attributeValue : attributeValues) {

        String attributeValueStr =
            getAttributeValueString(attributeType, attributeValue);

        sb.append(MessageFormat.format("{0}: {1}", attributeTypeStr,
                                       attributeValueStr));
        sb.append(NEWLINE);
      }
    }
  ...
  private static String getSubjectKeyIndentifierStringValue(byte[] value)
      throws IOException {
    // @formatter:off
    ...
    SubjectKeyIdentifier subjectKeyIdentifier =
        SubjectKeyIdentifier.getInstance(value);
  ...
  private static String getAuthorityKeyIdentifierStringValue(byte[] value)
      throws IOException {
    // @formatter:off
    ...
    AuthorityKeyIdentifier authorityKeyIdentifier =
        AuthorityKeyIdentifier.getInstance(value);
    ...
    if (certificateSerialNumber != null) { // Optional
      ...
      sb.append(
          MessageFormat.format(res.getString("CertificateSerialNumber"),
  ...
  private static String getKeyUsageStringValue(byte[] value)
      throws IOException {
    // @formatter:off
    ...
    ASN1BitString keyUsage =
        ASN1BitString.getInstance(ASN1Primitive.fromByteArray(value));
  ...
  private static String getPrivateKeyUsagePeriodStringValue(byte[] value)
    ...
    PrivateKeyUsagePeriod privateKeyUsagePeriod =
        PrivateKeyUsagePeriod.getInstance(value);
    ...
    if (notBefore != null) {
      sb.append(
          MessageFormat.format(res.getString("NotBeforePrivateKeyUsagePeriod"),
    ...
    if (notAfter != null) {
      sb.append(
          MessageFormat.format(res.getString("NotAfterPrivateKeyUsagePeriod"),
  ...
  private static String getSubjectAlternativeNameStringValue(byte[] value)
      throws IOException {
    // @formatter:off
  ...
  private static String getIssuerAlternativeNameStringValue(byte[] value)
      throws IOException {
    // @formatter:off
  ...
  private static String getBasicConstraintsStringValue(byte[] value)
    ...
    if (pathLenConstraint != null) {
      sb.append(MessageFormat.format(res.getString("PathLengthConstraint"),
                                     pathLenConstraint.intValue()));
      sb.append(NEWLINE);
    } else {
  ...
  private static String getHoldInstructionCodeStringValue(byte[] value)
    ...
    ASN1ObjectIdentifier holdInstructionCode =
        ASN1ObjectIdentifier.getInstance(value);
  ...
  private static String getIssuingDistributionPointStringValue(byte[] value)
      throws IOException {
    // @formatter:off
    ...
    IssuingDistributionPoint issuingDistributionPoint =
        IssuingDistributionPoint.getInstance(value);
    ...
    boolean onlyContainsCaCerts =
        issuingDistributionPoint.onlyContainsCACerts();
    sb.append(MessageFormat.format(res.getString("OnlyContainsCaCerts"),
                                   onlyContainsCaCerts));
    sb.append(NEWLINE);
    ...
    sb.append(MessageFormat.format(res.getString("OnlyContainsAttributeCerts"),
  ...
  private static String getCertificateIssuerStringValue(byte[] value)
      throws IOException {
    // @formatter:off
  ...
  private static String getNameConstraintsStringValue(byte[] value)
      throws IOException {
    // @formatter:off
    ...
    if (nameConstraints.getPermittedSubtrees() != null &&
      ...
      permittedSubtrees =
          new GeneralSubtrees(nameConstraints.getPermittedSubtrees());
    }
    ...
    if (permittedSubtrees == null) {
      ...
      for (GeneralSubtree permittedSubtree :
           permittedSubtrees.getGeneralSubtrees()) {
        permitted++;

        sb.append(INDENT);
        sb.append(
            MessageFormat.format(res.getString("PermittedSubtree"), permitted));
        sb.append(NEWLINE);
    ...
    if (excludedSubtreeArray == null) { // Optional
      ...
      GeneralSubtrees excludedSubtrees =
          new GeneralSubtrees(excludedSubtreeArray);

      sb.append(NEWLINE);

      int excluded = 0;

      for (GeneralSubtree excludedSubtree :
           excludedSubtrees.getGeneralSubtrees()) {
        excluded++;

        sb.append(INDENT);
        sb.append(
            MessageFormat.format(res.getString("ExcludedSubtree"), excluded));
        sb.append(NEWLINE);
  ...
  private static String getCrlDistributionPointsStringValue(byte[] value)
      throws IOException {
    // @formatter:off
    ...
    for (DistributionPoint distributionPoint :
         crlDistributionPoints.getDistributionPoints()) {
      distPoint++;

      sb.append(MessageFormat.format(res.getString("CrlDistributionPoint"),
                                     distPoint));
      sb.append(NEWLINE);

      sb.append(
          getDistributionPointString(distributionPoint, INDENT.toString(1)));
    }
  ...
  private static String getCertificatePoliciesStringValue(byte[] value)
    ...
    CertificatePolicies certificatePolicies =
        CertificatePolicies.getInstance(value);

    int certPolicy = 0;

    for (PolicyInformation policyInformation :
         certificatePolicies.getPolicyInformation()) {
      certPolicy++;

      sb.append(
          MessageFormat.format(res.getString("CertificatePolicy"), certPolicy));
      sb.append(NEWLINE);
      ...
      sb.append(INDENT);
      sb.append(MessageFormat.format(res.getString("PolicyIdentifier"),
                                     policyIdentifierStr));
      sb.append(NEWLINE);
      ...
      if (policyQualifiers != null) { // Optional
        ...
        for (ASN1Encodable policyQualifier : policyQualifiers.toArray()) {
          ...
          sb.append(
              MessageFormat.format(res.getString("PolicyQualifierInformation"),
                                   certPolicy, ++policyQual));
          sb.append(NEWLINE);

          ASN1ObjectIdentifier policyQualifierId =
              (ASN1ObjectIdentifier)policyQualifierInfo.getObjectAt(0);
          ...
          if (certificatePolicyQualifierType != null) {
            ...
            if (certificatePolicyQualifierType == PKIX_CPS_POINTER_QUALIFIER) {
              DERIA5String cpsPointer =
                  (DERIA5String)policyQualifierInfo.getObjectAt(1);
              ...
              sb.append(MessageFormat.format(res.getString("CpsPointer"),
                                             "<a href=\"" + cpsPointer + "\">" +
                                                 cpsPointer + "</a>"));
              sb.append(NEWLINE);
            } else if (certificatePolicyQualifierType ==
                       PKIX_USER_NOTICE_QUALIFIER) {
              ...
              if (noticeReference != null) { // Optional
                ...
                sb.append(MessageFormat.format(res.getString("Organization"),
                                               organizationString));
                sb.append(NEWLINE);
              ...
              if (explicitText != null) { // Optional
                ...
                sb.append(INDENT.toString(3));
                sb.append(MessageFormat.format(res.getString("ExplicitText"),
                                               explicitTextString));
                sb.append(NEWLINE);
              }
            }
  ...
  private static String getPolicyMappingsStringValue(byte[] value)
    ...
    for (ASN1Encodable policyMapping : policyMappingsSeq.toArray()) {
      ...
      ASN1Sequence policyMappingSeq =
          ASN1Sequence.getInstance(policyMapping.toASN1Primitive());
      polMap++;
      ...
      ASN1ObjectIdentifier issuerDomainPolicy =
          (ASN1ObjectIdentifier)policyMappingSeq.getObjectAt(0);
      ASN1ObjectIdentifier subjectDomainPolicy =
          (ASN1ObjectIdentifier)policyMappingSeq.getObjectAt(1);

      sb.append(INDENT);
      sb.append(
          MessageFormat.format(res.getString("IssuerDomainPolicy"),
                               ObjectIdUtil.toString(issuerDomainPolicy)));
      sb.append(NEWLINE);

      sb.append(INDENT);
      sb.append(
          MessageFormat.format(res.getString("SubjectDomainPolicy"),
  ...
  private static String getPolicyConstraintsStringValue(byte[] value)
    ...
    BigInteger requireExplicitPolicy =
        policyConstraints.getRequireExplicitPolicyMapping();
    BigInteger inhibitPolicyMapping =
        policyConstraints.getInhibitPolicyMapping();

    if (requireExplicitPolicy != null) { // Optional
      sb.append(MessageFormat.format(res.getString("RequireExplicitPolicy"),
                                     requireExplicitPolicy));
      sb.append(NEWLINE);
    }

    if (inhibitPolicyMapping != null) { // Optional
      sb.append(MessageFormat.format(res.getString("InhibitPolicyMapping"),
  ...
  private static String getFreshestCrlStringValue(byte[] value)
      throws IOException {
    // @formatter:off
    ...
    CRLDistributionPoints freshestCRL =
        CRLDistributionPoints.getInstance(value);

    int distPoint = 0;

    for (DistributionPoint distributionPoint :
         freshestCRL.getDistributionPointList()) {
      distPoint++;

      sb.append(MessageFormat.format(
          res.getString("FreshestCrlDistributionPoint"), distPoint));
      sb.append(NEWLINE);
  ...
  private static String getInhibitAnyPolicyStringValue(byte[] value)
    ...
    sb.append(
        MessageFormat.format(res.getString("InhibitAnyPolicy"), skipCerts));
    sb.append(NEWLINE);

    return sb.toString();
  }

  private static String getNetscapeCertificateTypeStringValue(byte[] value)
      throws IOException {
    // @formatter:off
    ...
    ASN1BitString netscapeCertType =
        ASN1BitString.getInstance(new ASN1InputStream(value).readObject());
  ...
  getDistributionPointString(DistributionPoint distributionPoint,
                             String baseIndent) throws IOException {
    // @formatter:off
    ...
    if (distributionPointName != null) { // Optional
      sb.append(
          getDistributionPointNameString(distributionPointName, baseIndent));
    }
  ...
  private static String
  getDistributionPointNameString(DistributionPointName distributionPointName,
                                 String baseIndent) throws IOException {
    // @formatter:off
    ...
    if (distributionPointName.getType() == DistributionPointName.FULL_NAME) {
      ...
      GeneralNames generalNames =
          GeneralNames.getInstance(distributionPointName.getName());
  ...
  private static String[] getReasonFlagsStrings(ReasonFlags reasonFlags) {
    ...
    DERBitString reasonFlagsBitString =
        (DERBitString)reasonFlags.toASN1Primitive();
  ...
  private static String getAttributeTypeString(ASN1ObjectIdentifier oid) {
    ...
    AttributeTypeType attributeTypeType =
        AttributeTypeType.resolveOid(oid.getId());
  ...
  private static String
  getAttributeValueString(ASN1ObjectIdentifier attributeType,
                          ASN1Encodable attributeValue) throws IOException {
    ...
    case DATE_OF_BIRTH:
      return getGeneralizedTimeString(
          ASN1GeneralizedTime.getInstance(attributeValue));
    case SERIAL_NUMBER:
    ...
    default:
      ...
      return HexUtil.getHexString(
          attributeValue.toASN1Primitive().getEncoded());
    }
  }

  private static String
  getGeneralizedTimeString(ASN1GeneralizedTime asn1GeneralizedTime) {
    try {
  ...
  private static String getBiometricInfoStringValue(byte[] octets) {
    ...
    for (ASN1Encodable asn1Encodable : asn1Sequence.toArray()) {
      ...
      sb.append(MessageFormat.format(
          res.getString("BiometricInfo.BiometricData"), biometricDataNr));
      sb.append(NEWLINE);
      ...
      if (typeOfBiometricData.isPredefined()) {
        ...
        sb.append(MessageFormat.format(
            res.getString("BiometricInfo.TypeOfBiometricData"), type));
      } else {
        String biometricDataOid =
            typeOfBiometricData.getBiometricDataOid().getId();
        sb.append(MessageFormat.format(
            res.getString("BiometricInfo.TypeOfBiometricData"),
            biometricDataOid));
      }
      sb.append(NEWLINE);
      ...
      sb.append(INDENT);
      sb.append(
          MessageFormat.format(res.getString("BiometricInfo.HashAlgorithm"),
                               hashAlgorithm.getAlgorithm().getId()));
      sb.append(NEWLINE);

      sb.append(INDENT);
      sb.append(MessageFormat.format(
          res.getString("BiometricInfo.BiometricDataHash"),
      ...
      if (sourceDataUri != null) { // optional
        sb.append(INDENT);
        sb.append(
            MessageFormat.format(res.getString("BiometricInfo.SourceDataUri"),
  ...
  private static String getQcStatementsStringValue(byte[] octets)
      throws IOException {
    ...
    for (ASN1Encodable asn1Encodable : qcStatements.toArray()) {
      ...
      sb.append(MessageFormat.format(res.getString("QCStatement.QCStatement"),
                                     ++qcStatementNr));
      sb.append(NEWLINE);

      QcStatementType qcStatementType =
          QcStatementType.resolveOid(statementId.getId());
      switch (qcStatementType) {
      case QC_SYNTAX_V1:
      case QC_SYNTAX_V2:
        SemanticsInformation semanticsInfo =
            SemanticsInformation.getInstance(statementInfo);
        sb.append(getSemanticInformationValueString(
            qcStatementType, semanticsInfo, indentLevel));
        break;
      case QC_COMPLIANCE:
        // no statementInfo
      ...
      case QC_RETENTION_PERIOD:
        ...
        sb.append(INDENT.toString(indentLevel));
        sb.append(MessageFormat.format(
            res.getString(QcStatementType.QC_RETENTION_PERIOD.getResKey()),
      ...
      case QC_PDS:
        ...
        for (ASN1Encodable pdsLoc : pdsLocations) {
          ...
          sb.append(MessageFormat.format(res.getString("QCPDS.locations"),
                                         pds.getObjectAt(1),
                                         pds.getObjectAt(0)));
        }
        sb.append(NEWLINE);
  ...
  private static String
  getSemanticInformationValueString(QcStatementType qcStatementType,
                                    SemanticsInformation semanticsInfo,
                                    int baseIndentLevel) throws IOException {
    ...
    ASN1ObjectIdentifier semanticsIdentifier =
        semanticsInfo.getSemanticsIdentifier();
    GeneralName[] nameRegistrationAuthorities =
        semanticsInfo.getNameRegistrationAuthorities();
    ...
    if (semanticsIdentifier != null) {
      ...
      sb.append(
          MessageFormat.format(res.getString("QCSyntax.SemanticsIdentifier"),
    ...
    if (nameRegistrationAuthorities != null) {
      ...
      for (GeneralName nameRegistrationAuthority :
  ...
  private static String getMonetaryValueStringValue(ASN1Encodable asn1Encodable,
    ...
    if (currency != null) {
      String currencyString = currency.isAlphabetic()
                                  ? currency.getAlphabetic()
                                  : "" + currency.getNumeric();
      sb.append(INDENT.toString(baseIndentLevel));
      sb.append(MessageFormat.format(res.getString("QCEuLimitValue.Currency"),
                                     currencyString));
      sb.append(NEWLINE);
    }
    ...
    if (amount != null) {
      sb.append(INDENT.toString(baseIndentLevel));
      sb.append(MessageFormat.format(res.getString("QCEuLimitValue.Amount"),
                                     amount.toString()));
      sb.append(NEWLINE);
    }
    ...
    if (exponent != null) {
      sb.append(INDENT.toString(baseIndentLevel));
      sb.append(MessageFormat.format(res.getString("QCEuLimitValue.Exponent"),
                                     exponent.toString()));
      sb.append(NEWLINE);
    }
  ...
  private static String getOcspNoCheckStringValue() {
    ...
    // we return the extension name as the value, because only its existence
    // matters and 'NULL' might be confusing
    return res.getString("OCSPNoCheck");
  }

  private static String getAdmissionStringValue(byte[] octets)
      throws IOException {
    ...
    AdmissionSyntax admissionSyntax =
        AdmissionSyntax.getInstance(ASN1Sequence.getInstance(octets));
    GeneralName admissionAuthority = admissionSyntax.getAdmissionAuthority();

    if (admissionAuthority != null) {
      sb.append(
          MessageFormat.format(res.getString("Admission.AdmissionAuthority"),
    ...
    for (Admissions admission : admissions) {
      sb.append(MessageFormat.format(res.getString("Admission.Admission"),
                                     ++admissionNr));
      sb.append(NEWLINE);
      ...
      for (ProfessionInfo professionInfo : professionInfos) {
        ...
        if (namingAuthority != null) {
          sb.append(
              getNamingAuthorityStringValue(namingAuthority, indentLevel));
        }
        ...
        for (DirectoryString professionItem : professionItems) {
          sb.append(INDENT.toString(indentLevel));
          sb.append(
              MessageFormat.format(res.getString("Admission.ProfessionItem"),
        ...
        if (professionOIDs != null) {
          for (ASN1ObjectIdentifier professionOID : professionOIDs) {
            sb.append(INDENT.toString(indentLevel));
            sb.append(
                MessageFormat.format(res.getString("Admission.ProfessionOID"),
                                     professionOID.getId()));
            sb.append(NEWLINE);
          }
        }
        ...
        if (registrationNumber != null) {
          sb.append(INDENT.toString(indentLevel));
          sb.append(MessageFormat.format(
              res.getString("Admission.RegistrationNumber"),
              registrationNumber));
          sb.append(NEWLINE);
        }
        ...
        if (addProfessionInfo != null) {
          sb.append(INDENT.toString(indentLevel));
          sb.append(MessageFormat.format(
              res.getString("Admission.AddProfessionInfo"),
  ...
  private static String
  getNamingAuthorityStringValue(NamingAuthority namingAuthority,
                                int indentLevel) {
    ...
    DirectoryString namingAuthorityText =
        namingAuthority.getNamingAuthorityText();

    if (namingAuthorityId != null) {
      sb.append(INDENT.toString(indentLevel));
      sb.append(
          MessageFormat.format(res.getString("Admission.NamingAuthorityOID"),
                               namingAuthorityId.getId()));
      sb.append(NEWLINE);
    }
    ...
    if (namingAuthorityUrl != null) {
      sb.append(INDENT.toString(indentLevel));
      sb.append(MessageFormat.format(
          res.getString("Admission.NamingAuthorityURL"), namingAuthorityUrl));
      sb.append(NEWLINE);
    }
    ...
    if (namingAuthorityText != null) {
      sb.append(INDENT.toString(indentLevel));
      sb.append(
          MessageFormat.format(res.getString("Admission.NamingAuthorityText"),
  ...
  private static String getDateOfCertGenStringValue(byte[] octets) {
    ...
    ASN1GeneralizedTime dateOfCertGenSyntax =
        ASN1GeneralizedTime.getInstance(octets);
    return getGeneralizedTimeString(dateOfCertGenSyntax);
  }

  private static String getProcurationStringValue(byte[] octets)
      throws IOException {
    ...
    /*
        ProcurationSyntax ::= SEQUENCE
        {
            ...
            typeOfSubstitution [2] EXPLICIT DirectoryString(SIZE(1..128))
       OPTIONAL, signingFor [3] EXPLICIT SigningFor
        }
    ...
    DirectoryString typeOfSubstitution =
        procurationSyntax.getTypeOfSubstitution();
    GeneralName thirdPerson = procurationSyntax.getThirdPerson();
    IssuerSerial certRef = procurationSyntax.getCertRef();

    if (country != null) {
      sb.append(
          MessageFormat.format(res.getString("Procuration.Country"), country));
      sb.append(NEWLINE);
    }

    if (typeOfSubstitution != null) {
      sb.append(
          MessageFormat.format(res.getString("Procuration.TypeOfSubstitution"),
    ...
    if (certRef != null) {
      ...
      sb.append(INDENT);
      sb.append(MessageFormat.format(
          res.getString("Procuration.CertRef.SN"),
  ...
  private static String getMonetaryLimitStringValue(byte[] octets) {
    ...
    if (currency != null) {
      sb.append(MessageFormat.format(res.getString("MonetaryLimit.Currency"),
                                     currency));
      sb.append(NEWLINE);
    }

    if (amount != null) {
      sb.append(MessageFormat.format(res.getString("MonetaryLimit.Amount"),
                                     amount.toString()));
      sb.append(NEWLINE);
    }

    if (exponent != null) {
      sb.append(MessageFormat.format(res.getString("MonetaryLimit.Exponent"),
                                     exponent.toString()));
      sb.append(NEWLINE);
    }
  ...
  private static String getDeclarationOfMajorityStringValue(byte[] octets) {
    ...
    DeclarationOfMajority declarationOfMajority =
        DeclarationOfMajority.getInstance(octets);
    ...
    if (notYoungerThan != -1) {
      sb.append(MessageFormat.format(
          res.getString("DeclarationOfMajority.notYoungerThan"),
          notYoungerThan));
      sb.append(NEWLINE);
    }
    ...
    if (fullAgeAtCountry != null) {
      ASN1Boolean fullAge =
          ASN1Boolean.getInstance(fullAgeAtCountry.getObjectAt(0));
      ASN1PrintableString country =
          ASN1PrintableString.getInstance(fullAgeAtCountry.getObjectAt(1));

      sb.append(MessageFormat.format(
          res.getString("DeclarationOfMajority.fullAgeAtCountry"),
    ...
    if (dateOfBirth != null) {
      sb.append(MessageFormat.format(
          res.getString("DeclarationOfMajority.dateOfBirth"), dateOfBirth));
      sb.append(NEWLINE);
    }
  ...
  private static String getRestrictionStringValue(byte[] octets)
      throws IOException {

    /*	RestrictionSyntax ::= DirectoryString (SIZE(1..1024)) */

    return DirectoryString.getInstance(ASN1Primitive.fromByteArray(octets))
        .toString();
  }

  private static String getAdditionalInformationStringValue(byte[] octets)
      throws IOException {
  ...
  private static String getValidityModelStringValue(byte[] octets) {
    ...
    ASN1ObjectIdentifier oid =
        ASN1ObjectIdentifier.getInstance(asn1Sequence.getObjectAt(0));
  ...
  private static String getMsCertTypeStringValue(byte[] octets) {
    ...
    /*
        ...
        |     ; 1.3.6.1.4.1.311.20.2 Certificate Template Name (Certificate
       Type) 04 0a		; OCTET_STRING (a Bytes)# 1e 08 00 55 00 73 00
       65  00 72                    ; ...U.s.e.r
     */
    // @formatter:on
  ...
  private static String getMsCaVersionStringValue(byte[] octets) {
    ...
    /*
        "The extension data is a DWORD value (encoded as X509_INTEGER in the
       extension); the low 16 bits are the certificate index, and the high 16
       bits are the key index."
     */
    ...
    sb.append(MessageFormat.format(res.getString("MSCaVersion.CertIndex"),
                                   certIndex));
    sb.append(NEWLINE);
    sb.append(
  ...
  private static String getMsCertificateTemplateStringValue(byte[] octets) {
    ...
    ASN1Sequence asn1Sequence = ASN1Sequence.getInstance(octets);
    ASN1ObjectIdentifier templateID =
        (ASN1ObjectIdentifier)asn1Sequence.getObjectAt(0);
    ...
    sb.append(MessageFormat.format(res.getString("MSCertificateTemplate.ID"),
                                   templateID.getId()));
    sb.append(NEWLINE);

    sb.append(MessageFormat.format(
        res.getString("MSCertificateTemplate.MajorVersion"), majorVersion));
    sb.append(NEWLINE);

    if (minorVersion != null) {
      sb.append(MessageFormat.format(
          res.getString("MSCertificateTemplate.MinorVersion"), minorVersion));
      sb.append(NEWLINE);
    }
  ...
  private static String getSMIMECapabilitiesStringValue(byte[] octets)
      throws IOException {
    ...
    for (ASN1Encodable asn1Encodable : asn1Sequence.toArray()) {
      ...
      sb.append(MessageFormat.format(res.getString("SMIMECapability"),
                                     ++capabilityNr));
      sb.append(NEWLINE);

      sb.append(INDENT);
      sb.append(MessageFormat.format(res.getString("SMIMECapability.ObjectID"),
      ...
      if (parameters != null) {
        sb.append(INDENT);
        sb.append(MessageFormat.format(
            res.getString("SMIMECapability.Parameter"),
  ...
  private static String getBitString(byte[] octets) throws IOException {
    ...
    ASN1BitString derBitString =
        ASN1BitString.getInstance(ASN1Primitive.fromByteArray(octets));
    byte[] bitStringBytes = derBitString.getBytes();

    return new BigInteger(1, bitStringBytes).toString(2);
  }

  private static String getVeriSignNonVerified(byte[] octets)
      throws IOException {
    ...
    for (ASN1Encodable attribute : asn1Set.toArray()) {
      ...
      for (ASN1Encodable attributeValue : attributeValues.toArray()) {
        ...
        String attributeValueStr =
            getAttributeValueString(attributeId, attributeValue);

        sb.append(MessageFormat.format("{0}={1}", attributeId.getId(),
                                       attributeValueStr));
        sb.append(NEWLINE);
      }
    }
