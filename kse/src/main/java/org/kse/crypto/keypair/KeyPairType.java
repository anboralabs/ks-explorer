...
public enum KeyPairType {
  ...
  EDDSA("EdDSA", "", 256, 456,
        200), // for Java >= 15 (there is no specific OID for EdDSA)
  ED25519("Ed25519", "1.3.101.112", 256, 256,
          0), // BC has separate key pair types for the two EdDSA types
  ED448("Ed448", "1.3.101.113", 456, 456, 0);

  /**
   * Set of all EC key pair types (EC, ECDSA, EDDSA, ED25519, ED448)
   */
  public static final EnumSet<KeyPairType> EC_TYPES_SET =
      EnumSet.of(EC, ECDSA, EDDSA, ED25519, ED448);
