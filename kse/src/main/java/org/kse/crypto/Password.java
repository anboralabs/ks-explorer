...
public class Password {
  private static ResourceBundle res =
      ResourceBundle.getBundle("org/kse/crypto/resources");
  ...
  public Password(Password password) {
    if (password.isNulled()) {
      ...
      if (wrappedPwd != null) {
        ...
        System.arraycopy(wrappedPwd, 0, this.wrappedPassword, 0,
                         this.wrappedPassword.length);
      }
    }
  }
   ...
   * @throws IllegalStateException If password requested after it has been
   *     nulled
   */
  public char[] toCharArray() throws IllegalStateException {
    if (nulled) {
      throw new IllegalStateException(
          res.getString("NoGetPasswordNulled.message"));
    }
   ...
   */
  public boolean isEmpty() { return wrappedPassword.length == 0; }
