...
public final class DigestUtil {
   ...
   */
  public static byte[] getMessageDigest(InputStream istream,
    ...
    try {
      ...
      throw new CryptoException(
          res.getString("NoCreateDigest.exception.message"), ex);
    } finally {
   ...
   * @throws CryptoException If message digester could not be created
   */
  public static byte[] getMessageDigest(byte[] message, DigestType digestType)
      throws CryptoException {
    MessageDigest messageDigester = getMessageDigester(digestType);
   ...
   * @throws CryptoException If message digester could not be created
   */
  public static String getFriendlyMessageDigest(byte[] message,
                                                DigestType digestType)
      throws CryptoException {
   ...
   * @throws CryptoException If message digester could not be created
   */
  public static MessageDigest getMessageDigester(DigestType digestType)
      throws CryptoException {
    try {
      ...
      throw new CryptoException(
          MessageFormat.format(
              res.getString("NoCreateDigester.exception.message"),
              digestType.jce()),
          ex);
    }
  }
