...
public class StringUtils {
  ...
  /**
   * Add given string to list. The string is put at the first position of the
   * new list. If the list already contains this value, it is moved to the first
   * position instead. If maxSize is exceeded after adding the value, the last
   * item in the list is removed. <p> Note: This does not modify the input list
   * (as it is probably immutable), but returns a new list instead.
   * </p>
   *
   ...
   */
  public static List<String> addToList(String value, List<String> list,
                                       int maxSize) {
