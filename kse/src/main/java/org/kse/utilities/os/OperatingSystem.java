...
public class OperatingSystem {
   ...
   * @return True if it is
   */
  public static boolean isWindows() { return OS_NAME.contains("Windows"); }
   ...
   * @return True if it is
   */
  public static boolean isLinux() { return OS_NAME.contains("Linux"); }
   ...
   * @return True if it is
   */
  public static boolean isMacOs() { return OS_NAME.contains("Mac OS"); }
   ...
   * @return True if it is
   */
  public static boolean isAix() { return OS_NAME.contains("AIX"); }
   ...
   * @return True if it is
   */
  public static boolean isFreeBsd() { return OS_NAME.contains("FreeBSD"); }
   ...
   * @return True if it is
   */
  public static boolean isHpUx() { return OS_NAME.contains("HP-UX"); }
   ...
   * @return True if it is
   */
  public static boolean isIrix() { return OS_NAME.contains("Irix"); }
   ...
   * @return True if it is
   */
  public static boolean isOs2() { return OS_NAME.contains("OS/2"); }
