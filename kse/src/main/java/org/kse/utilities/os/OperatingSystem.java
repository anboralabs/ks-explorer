...
public class OperatingSystem {
  ...
  public static boolean isWindows8() {
    return OS_NAME.indexOf("Windows") > -1 &&
        (OS_VERSION.equals("6.2") || OS_VERSION.equals("6.3"));
  }
   ...
   * @return True if it is
   */
  public static boolean isWindows() { return OS_NAME.indexOf("Windows") > -1; }
   ...
   * @return True if it is
   */
  public static boolean isLinux() { return OS_NAME.indexOf("Linux") > -1; }
   ...
   * @return True if it is
   */
  public static boolean isMacOs() { return OS_NAME.indexOf("Mac OS") > -1; }
   ...
   * @return True if it is
   */
  public static boolean isAix() { return OS_NAME.indexOf("AIX") > -1; }
   ...
   * @return True if it is
   */
  public static boolean isFreeBsd() { return OS_NAME.indexOf("FreeBSD") > -1; }
   ...
   * @return True if it is
   */
  public static boolean isHpUx() { return OS_NAME.indexOf("HP-UX") > -1; }
   ...
   * @return True if it is
   */
  public static boolean isIrix() { return OS_NAME.indexOf("Irix") > -1; }
   ...
   * @return True if it is
   */
  public static boolean isOs2() { return OS_NAME.indexOf("OS/2") > -1; }
